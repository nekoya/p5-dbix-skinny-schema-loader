...
use DBIx::Skinny::Schema::Loader qw/make_schema_tidily_at/;
ok my $schema = make_schema_tidily_at(
    'Mock::DB::Schema',
    {
    },
    [ 'dbi:SQLite:test.db', '', '' ]
), 'got schema class file content by make_schema_tidily_at';
...
ok make_schema_tidily_at(
    'Mock::DB::Schema',
    {
    },
    { dsn => 'dbi:SQLite:test.db', username => '', password => '' }
), 'got schema class file content by make_schema_tidily_at(hashref style connect options)';
